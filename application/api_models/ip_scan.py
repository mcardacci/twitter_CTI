...
# To grab ip from hostname:
	## Remember to take out the 'https://' and everything after the '.com' 
'''
import socket
socket.gethostbyname('coderwall.com')
'''
#---------------------------------------------------------------------
...
# -------------TESTING-------------------------
ip_scanner = IP_Scanner_Model('https://stackoverflow.com/questions/9626535/get-domain-name-from-url')
ip_scanner.get_ip_from_domain()